...
4. **Administrasi**
   - **Pengaturan** → `/app/pengaturan` — Tenant Admin only. Its own menu holds Profil gerai (`/app/pengaturan`), Titik pickup (`/app/pengaturan/pickup`), Outlet (`/app/pengaturan/outlet`), Koneksi Mengantar (`/app/pengaturan/koneksi`) and Anggota & akses (`/app/anggota`).
