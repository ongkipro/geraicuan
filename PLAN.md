...
2. Configuration: tenants/outlets, private-first Mengantar resolver with platform environment fallback.
...
- Implementation evidence is intentionally absent until a repository exists and tasks are executed.
