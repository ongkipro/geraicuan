ALTER TABLE "outlets" ADD COLUMN "mengantar_authority_version" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE "outlets" ADD CONSTRAINT "outlets_mengantar_authority_version_nonnegative" CHECK (mengantar_authority_version >= 0);--> statement-breakpoint
DROP POLICY "shipment_estimate_snapshots_active_tenant_insert" ON shipment_estimate_snapshots;--> statement-breakpoint
...
DROP POLICY "provider_order_snapshots_active_tenant_insert" ON provider_order_snapshots;--> statement-breakpoint
