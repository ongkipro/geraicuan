...
export const TENANT_APPROVAL_COPY = {
  ...
  body:
    "Admin platform GeraiCUAN sedang memeriksa pendaftaran gerai ini. Sambil menunggu, lengkapi outlet, titik pickup dan hubungkan akun Mengantar milik gerai Anda. Membuat, mengestimasi dan menerbitkan kiriman terbuka setelah gerai disetujui; kami kirim email begitu keputusan dibuat.",
  refused:
