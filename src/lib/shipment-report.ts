...
export const SHIPMENT_REPORT_COLUMNS = [
  ...
  { csvHeader: "lifecycle", label: "Lifecycle", metricId: "RPT-SHP-LIFECYCLE", value: (row) => row.status },
  { csvHeader: "pembayaran", label: "Pembayaran", metricId: "RPT-SHP-PAYMENT-MODE", value: (row) => row.isCod ? "COD" : "NON_COD" },
