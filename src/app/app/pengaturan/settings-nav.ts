...
/** The settings index: Profil gerai, and the page the mobile back link returns to. */
...
export const administrationNavigation: readonly SettingsNavItem[] = [
  {
    description: "Nama gerai, awalan nomor kiriman, format tanggal.",
    href: "/app/pengaturan",
    icon: Store,
    label: "Profil gerai",
  },
  ...
  {
    description: "Koneksi bawaan GeraiCUAN atau akun Mengantar milik outlet.",
