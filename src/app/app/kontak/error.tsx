...
export default function ContactDirectoryError({ reset }: { reset: () => void }) {
  ...
  return (
    <PageContainer>
      <PageHeader eyebrow="Data" title="Kontak" />
      <Alert ref={alertRef} tabIndex={-1} variant="destructive">
        <CircleAlert aria-hidden="true" />
        <AlertTitle>Direktori kontak belum dapat dimuat</AlertTitle>
