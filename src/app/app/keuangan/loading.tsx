...
export default function FinanceLoading() {
  return <PageContainer aria-busy="true" aria-label="Memuat ledger dan rekonsiliasi">
    ...
    <section className="grid gap-4"><Skeleton className="h-6 w-40" /><Skeleton className="h-72 w-full rounded-md" /><div className="flex justify-between"><Skeleton className="h-8 w-24" /><Skeleton className="h-8 w-72 max-w-full" /></div></section>
  </PageContainer>;
}
