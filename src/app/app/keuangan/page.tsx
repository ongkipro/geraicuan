...
export default async function FinancePage({ searchParams }: FinancePageProps) {
  ...
  return <PageContainer width="data">
    ...
    <section aria-labelledby="ledger-entries-title" className={sectionClass}>
      <div><h2 className="text-xl font-semibold tracking-tight" id="ledger-entries-title">Entri ledger</h2><p className="mt-1 text-sm text-muted-foreground">Jejak append-only untuk {periodLabel}; nilai bertanda menunjukkan arah pencatatan.</p></div>
