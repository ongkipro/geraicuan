...
export default function LabelNotFound() {
  ...
  return (
    <PageContainer>
      <PageHeader description="Kiriman mungkin tidak tersedia atau bukan milik tenant aktif." eyebrow="Pengiriman" focusTargetId={HEADING_ID} title="Label tidak ditemukan" />
      <EmptyState
