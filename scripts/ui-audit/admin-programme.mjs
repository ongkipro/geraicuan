...
// page header.
const DATA_ROUTES=['/app','/app/pengiriman','/app/pengiriman/rts','/app/kontak','/app/label','/app/keuangan','/app/analitik'];
...
const STATIC_ROUTES=[
 ...
 '/app/kontak','/app/kontak/baru','/app/label','/app/analitik','/app/keuangan',
...
try {
 ...
 const SCREENING_ROUTES=[...STATIC_ROUTES,
  ...
  await discover('/app/kontak','/app/kontak/'),
 ...
 await viewport(1440);
 for(const route of ['/app/pengiriman','/app/pengiriman/rts','/app/kontak','/app/analitik','/app/keuangan','/app/label','/app/laporan/pengiriman','/app/laporan/cetak-resi']){
